export default function About() {
  return (
    <div className="bg-cream">
      ...
      {/* 헤더 */}
      <section className="px-6 sm:px-10 lg:px-20 xl:px-60 pt-12 sm:pt-16 lg:pt-24 pb-0 flex flex-col gap-3 items-center text-center">
        <p className="font-black text-[40px] sm:text-[52px] lg:text-[64px] text-[#4b4842] leading-[1.2] tracking-[6.4px]">
          프리랩의 이야기
        </p>
        <p className="font-medium text-base sm:text-xl lg:text-2xl text-[#4b4842] leading-[1.2] tracking-[2.4px]">
      ...
      {/* 본문 */}
      <section className="px-6 sm:px-10 lg:px-20 xl:px-60 py-12 sm:py-16 lg:py-24">
        <div className="max-w-[1000px] flex flex-col gap-8 lg:gap-10">

          <p className="text-sm sm:text-lg lg:text-2xl font-medium text-dark-brown/80 leading-[1.5] tracking-[-0.48px]">
          ...
          <p className="font-['Cafe24_Shiningstar'] text-[36px] sm:text-[48px] lg:text-[64px] text-dark-brown/80 leading-[1.5] tracking-[-1.28px] bg-white/50">
            "나는 지금 즐겁게 일하고 있나?"
          </p>
          ...
          <div className="bg-white/50 px-5 sm:px-6 py-4 sm:py-5 rounded-xl">
            <p className="text-lg sm:text-2xl lg:text-[32px] font-extrabold text-dark-brown/80 leading-[1.5] tracking-[-0.64px]">
